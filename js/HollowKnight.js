...
picnum[1] = "../Mainpage/Gimgs/HollowKnight/01.jpg";
picnum[2] = "../Mainpage/Gimgs/HollowKnight/02.jpg";
picnum[3] = "../Mainpage/Gimgs/HollowKnight/03.jpg";
picnum[4] = "../Mainpage/Gimgs/HollowKnight/04.jpg";
...
function Like(){
	...
	var gameinfo = new Gameinfo("空洞骑士", "Hollow Knight", "9.2", "NS,PS4,PC,XBOX", "HollowKnight");
...
function AddComment(){
	...
	if(comment == ""){
		...
		addc.append(commentdate);
		ctag.append(addc);
		gc3[i] = new obj(comment, date, "Hollow Knight");
