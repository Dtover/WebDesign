...
picnum[1] = "../Mainpage/Gimgs/MonsterHunterWorld/01.jpg";
picnum[2] = "../Mainpage/Gimgs/MonsterHunterWorld/02.jpg";
picnum[3] = "../Mainpage/Gimgs/MonsterHunterWorld/03.jpg";
picnum[4] = "../Mainpage/Gimgs/MonsterHunterWorld/04.jpg";
...
function AddComment(){
	...
	if(comment == ""){
		...
		addc.append(commentdate);
		ctag.append(addc);
		com[i] = new obj(comment, date, "Monster Hunter World");
		var strcomment = new Array();
